...
soundfile.write(
    data_root + output_prefix + ".wav", y[1], y[3], subtype="PCM_16"
)
...
files = list(
    list_filenames(output_root + "zcrgrams/" + output_prefix, [".png"])
)
files.sort()
...
np.save(
    output_root + output_prefix + "/output_" + output_prefix + ".npy", output
)
np.savetxt(
    output_root + output_prefix + "/output_" + output_prefix + ".csv",
    output,
    delimiter=",",
)
